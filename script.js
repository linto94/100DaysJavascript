...
btn.addEventListener("click", calcuateBMI);

function calcuateBMI(e) {
    e.preventDefault();
    ...
    if (height === "" || isNaN(height)) {
        return (result.innerHTML = "Provide a vaild Height");
    } else if (weight ==="" || isNaN(weight)) {
        return (result.innerHTML = "Provide a vaild Weight!")
    } else{
         height = height / 100;
